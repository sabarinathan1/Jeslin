...
public class MyCalculatorUsingAWT extends Frame
{
	...
	///////////////////////////
	MyCalculatorUsingAWT(String frameText)//constructor
	{
		super(frameText);
	...
	{
		new MyCalculatorUsingAWT("Calculator - JavaTpoint");
	}
}
...
{
	MyCalculatorUsingAWT cl;

	//////////////////////////////////////////
	MyDigitButton(int x,int y, int width,int height,String cap, MyCalculatorUsingAWT clc)
	{
		super(cap);
...
class MyOperatorButton extends Button implements ActionListener
{
	...
	MyOperatorButton(int x,int y, int width,int height,String cap, MyCalculatorUsingAWT clc)
	{
		super(cap);
		setBounds(x,y,width,height);
		this.cl=clc;
	...
	public void actionPerformed(ActionEvent ev)
	{
		...
		if(opText.equals("1/x"))
		{
			...
			cl.displayLabel.setText(MyCalculatorUsingAWT.getFormattedText(tempd));}
		...
		cl.displayLabel.setText(MyCalculatorUsingAWT.getFormattedText(temp));
		//cl.number=temp;
	}//actionPerformed
}//class
...
class MyMemoryButton extends Button implements ActionListener
{
	...
	/////////////////////////////////
	MyMemoryButton(int x,int y, int width,int height,String cap, MyCalculatorUsingAWT clc)
	{
		super(cap);
		setBounds(x,y,width,height);
		this.cl=clc;
	...
	public void actionPerformed(ActionEvent ev)
	{
		...
		case 'R': 
			cl.displayLabel.setText(MyCalculatorUsingAWT.getFormattedText(cl.memValue));break;
		case 'S':
			cl.memValue=0.0;
		case '+': 
...
class MySpecialButton extends Button implements ActionListener
{
	...
	MySpecialButton(int x,int y, int width,int height,String cap, MyCalculatorUsingAWT clc)
	{
		super(cap);
		setBounds(x,y,width,height);
		this.cl=clc;
